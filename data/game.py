...
pygame.display.set_caption('FIE FIGHTER')
        ...
        for event in pygame.event.get():
            ...
            # Keymap
                ...
                if event.key == pygame.K_SPACE:
                    ...
                    dictionaries.PLAYER_MEDIA['Mecanica'].update({'Parameters': [globals.game_modevalue]})
...
def char_select():
    ...
    loop = True
    color_choices = [
        ('Sistemas', 'Lanzar computadoras'),
        ('Software', 'Rayo digital'),
        ('Mecatronica', 'Golpe KUKA'),
        ('Mecanica', 'Golpe TESLA'),
        ('Electronica', 'Rayo laser'),
        ('Telematica', 'Lanzar antenas'),
        ('Oceanica', 'Golpe con tiburon'),
        ('Industrial', 'golpe con casco'),
        ('Quimica', 'golpe con bata')
    ]
    TEXTS1 = globals.FONT_BIG.render('Escoge tu ingenieria', True, globals.WHITE)
    TEXTS2 = globals.FONT_BIG.render('Espacio para continuar...', True, globals.WHITE)
...
def main():
    # Game Variables
    ABIL = {
        'Sistemas': functions.big_bullet,
        'Software': functions.big_bullet,
        'Mecatronica': functions.split_bullet,
        'Mecanica': functions.split_bullet,
        'Electronica': functions.beam,
        'Telematica': functions.beam,
        'Oceanica': functions.reverse_bullet,
        'Industrial': functions.reverse_bullet,
        'Quimica': functions.multi_bullet
